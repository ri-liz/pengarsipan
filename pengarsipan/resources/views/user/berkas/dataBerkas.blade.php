...
@section('title',"Berkas ".$dataBerkas["th"])
...
@section('breadcurb')
    ...
    <a href="{{route('user.page.berkas')}}" class="p-3 text-white no-underline rounded-lg hover:bg-[#4681ff]">Berkass <i class="fa fa-dashboard"></i></a> &gt;
    <a onclick="dataBerkas({{$dataBerkas['th']}})" class="p-3 text-white no-underline rounded-lg hover:bg-[#4681ff]" data-bs-toggle="modal" data-bs-target="#menuBerkas">
        {{$dataBerkas["th"]}}
    </a>
    <div class="modal" id="menuBerkas">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-2">
                        <label for="">File Berkas (Max 50 MB) : </label>
...
@push('script')
    ...
    <script>
        $(document).ready(function () {
            $('#example').DataTable({
                ajax:{
                    url:"{{route('user.page.berkas.post.berkas')}}",
                    type:"POST",
                    data:{
                        data:"{{$dataBerkas['th']}}",
                        _token:"{{csrf_token()}}"
